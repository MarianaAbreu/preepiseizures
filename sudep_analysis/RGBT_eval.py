# Description: This file contains the code to evaluate the RGBT dataset using the proposed method.
...
def score_classifier_pred(c, n, train, test, y_train, y_test, show=False):
    """
    This function trains a classifier and returns the classification accuracy
    :param c: classifier
    :param n: classifier name
    :param train: training data
    :param test: test data
    :param y_train: training labels
    :param y_test: test labels
    :param show: show the classification report
    :return: classification report and predicted labels
    """
...
def score_classifier_fusion(cl1, n, train, test, y_train, y_test, show=False):
    """
    This function fuses the prediction of two classifiers 
    :param cl1: classifier 1
    :param n: classifier name
    :param train: training data
    :param test: test data
    :param y_train: training labels
    :param y_test: test labels
    :param show: show the classification report
    :return: accuracy score and predicted labels
    """
    all_scores = []
    # classifier 2
...
def separate_classes_3(vecs, labs, classes=['A', 'N']):
    """
    This function separates the classes of the dataset
    :param vecs: dataset
    :param labs: labels
    :param classes: classes to separate
    :return: separated dataset and labels
    """
...
def classification(c, n, corr_size, label, training_set_x, testing_set_x, training_set_y, testing_set_y):
    """
    This function performs the classification of the dataset
    :param c: classifier
    :param n: classifier name
    :param corr_size: correlation size
    :param label: label of the dataset
    :param training_set_x: training data
    :param testing_set_x: test data
    :param training_set_y: training labels
    :param testing_set_y: test labels
    :return: accuracy score and predicted labels
    """
...
def plot_rgbt_data():
    ...
    Plot the RGBT data
    """
    # normalise the signals of specific users
